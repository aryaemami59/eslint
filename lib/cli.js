...
/**
 * @import { ESLint as ESLintType, Linter } from "eslint";
 * @import { ParsedCLIOptions } from "./options.js";
 */
 ...
 * @returns {Promise<Record<string, ESLintType.Plugin>>} A mapping of plugin short names to implementations.
 */
 ...
 * @param {Linter.LintMessage} message The lint result.
 ...
 * @param {{ ruleId: string; severity: Linter.Severity; }} rule The rule id and severity.
 ...
 *      config to generate.
 * @returns {Promise<ESLintType.Options>} The options object for the ESLint constructor.
 * @private
 */
 ...
 * @param {ESLintType.LintResult[]} results The results to print.
