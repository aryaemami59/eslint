...
/**
 * @import { Linter as LinterType, Rule, RuleTester as RuleTesterType } from "eslint";
 */

/**
 * A test case that is expected to pass lint.
 * @typedef {Object} ValidTestCase
 * @typedef {RuleTesterType.ValidTestCase['name']} [name] Name for the test case.
 * @property {RuleTesterType.ValidTestCase['code']} code Code for the test case.
 * @property {RuleTesterType.ValidTestCase['options']} [options] Options for the test case.
 ...
 * @property {RuleTesterType.ValidTestCase['languageOptions']} [languageOptions] The language options to use in the test case.
 * @property {LinterType.Config['settings']} [settings] Settings for the test case.
 * @property {RuleTesterType.ValidTestCase['filename']} [filename] The fake filename for the test case. Useful for rules that make assertion about filenames.
 * @property {RuleTesterType.ValidTestCase['only']} [only] Run only this test case or the subset of test cases with this property.
 */

/**
 * A test case that is expected to fail lint.
 * @typedef {Object} InvalidTestCase
 * @property {RuleTesterType.InvalidTestCase['name']} [name] Name for the test case.
 * @property {RuleTesterType.InvalidTestCase['code']} code Code for the test case.
 * @property {RuleTesterType.InvalidTestCase['errors']} errors Expected errors.
 * @property {RuleTesterType.InvalidTestCase['output']} [output] The expected code after autofixes are applied. If set to `null`, the test runner will assert that no autofix is suggested.
 * @property {RuleTesterType.InvalidTestCase['options']} [options] Options for the test case.
 * @property {Function} [before] Function to execute before testing the case.
 * @property {Function} [after] Function to execute after testing the case regardless of its result.
 * @property {RuleTesterType.InvalidTestCase['settings']} [settings] Settings for the test case.
 * @property {RuleTesterType.InvalidTestCase['filename']} [filename] The fake filename for the test case. Useful for rules that make assertion about filenames.
 * @property {RuleTesterType.InvalidTestCase['languageOptions']} [languageOptions] The language options to use in the test case.
 * @property {RuleTesterType.InvalidTestCase['only']} [only] Run only this test case or the subset of test cases with this property.
 */

/**
 * A description of a reported error used in a rule tester test.
 * @typedef {Object} TestCaseError
 * @property {RuleTesterType.TestCaseError['message']} [message] Message.
 * @property {RuleTesterType.TestCaseError['messageId']} [messageId] Message ID.
 * @property {RuleTesterType.TestCaseError['type']} [type] The type of the reported AST node.
 * @property {RuleTesterType.TestCaseError['data']} [data] The data used to fill the message template.
 * @property {RuleTesterType.TestCaseError['line']} [line] The 1-based line number of the reported start location.
 * @property {RuleTesterType.TestCaseError['column']} [column] The 1-based column number of the reported start location.
 * @property {RuleTesterType.TestCaseError['endLine']} [endLine] The 1-based line number of the reported end location.
 * @property {RuleTesterType.TestCaseError['endColumn']} [endColumn] The 1-based column number of the reported end location.
 */
 ...
 * @param {Rule.Node} node The node to define.
 * @returns {void}
 */
 ...
 * @param {Rule.Node} ast The root node to errorize `start`/`end` properties.
 ...
 * @param {LinterType.Parser} parser Parser object.
 * @returns {LinterType.Parser} Wrapped parser object.
 */
 ...
 * @param {undefined | Record<string, unknown>} data The passed
...
class RuleTester {
	 ...
	 * @param {Rule.RuleModule} rule The rule to test.
	 * @param {{
	...
	run(ruleName, rule, test) {
		 ...
		 * @param {Rule.Node} beforeAST AST node before running
		 * @param {Rule.Node} afterAST AST node after running
		 * @returns {void}
		 * @private
		 */
