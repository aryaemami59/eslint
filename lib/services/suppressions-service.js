 ...
 * @import { SuppressedViolations } from "../shared/types.js";
 */
...
class SuppressionsService {
	 ...
	 * @param {ESLint.LintResult[]|undefined} results The lint results.
	 ...
	 * @param {Linter.LintMessage[]} messages The messages to count.
	 ...
	 * @param {ESLint.LintResult} result The result to update.
