 ...
 * @property {string} filePath The path to a target file.
 * @property {ConfigArray} config The config entries of that file.
 * @property {typeof NONE | typeof IGNORED_SILENTLY | typeof IGNORED} flag The flag.
...
class FileEnumerator {
	...
	*iterateFiles(patternOrPatterns) {
	 ...
	 * @param {InstanceType<typeof Minimatch>} [options.selector] The matcher to choose files.
	 * @returns {IterableIterator<FileEntry>} The found files.
	 * @private
	 */
