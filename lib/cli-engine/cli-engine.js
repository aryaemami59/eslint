 ...
 * @property {FlatConfigArray} lastConfigArrays The list of config arrays that the last `executeOnFiles` or `executeOnText` used.
 ...
 * @returns {RuleDefinition|null} The rule or null.
 */
...
class CLIEngine {
	...
	getRules() {
		...
		if (!internalSlot) {
			throw new Error("The CLIEngine instance has been disposed.");
		}

		const { lastConfigArrays } = internalSlot;
