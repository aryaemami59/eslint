 ...
 * @param {Linter.LintMessage} message The message to check.
 ...
 * @param {Linter.LintMessage[]} messages Collection of messages
 ...
 * @param {ESLint.Options} options The options to process.
 * @throws {ESLintInvalidOptionsError} If of any of a variety of type errors.
 * @returns {Required<Omit<ESLint.Options, 'overrideConfigFile' | 'plugins'>> & { configFile: string | false | null }} The normalized options.
 */
