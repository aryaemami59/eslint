...
/**
 * @import { LintReport } from "../cli-engine/cli-engine.js";
 * @import { FlatConfigArray } from "../config/flat-config-array.js";
 * @import { Config } from "../config/config.js";
 * @import { Linter as LinterType, ESLint as ESLintType, Rule } from "eslint";
 * @import { DeprecatedInfo } from "@eslint/core";
 */
 ...
 * @property {ESLintType.ConfigData | ESLintType.ConfigData[]} [baseConfig] Base config, extended by all configs used with this instance
 ...
 * @property {ESLintType.ConfigData | ESLintType.ConfigData[]} [overrideConfig] Override config, overrides all configs used with this instance
 * @property {boolean|string} [overrideConfigFile] Searches for default config file when falsy;
 *      doesn't do any config file lookup when `true`; considered to be a config filename
 *      when a string.
 * @property {Record<string, ESLintType.Plugin>} [plugins] An array of plugin implementations.
 ...
 * @param {Map<string, Rule.RuleModule>} rules a map of rules from which to generate the object.
...
/** @type {WeakMap<FlatConfigArray, (ESLintType.DeprecatedRuleUse & { info?: DeprecatedInfo })[]>} */
 ...
 * @returns {(ESLintType.DeprecatedRuleUse & { info?: DeprecatedInfo })[]} The used deprecated rule list.
 */
 ...
 * @returns {ESLintType.LintResult[]} The processed linting results.
 */
 ...
 * @param {ESLintType.LintResult} a The first lint result.
 * @param {ESLintType.LintResult} b The second lint result.
 ...
 * @param {ESLintType.Options} options The ESLint instance options.
 ...
 * @param {InstanceType<typeof LinterType>} config.linter The linter instance to verify.
 * @returns {ESLintType.LintResult} The result of linting.
 * @private
 */
function verifyText({
	text,
 ...
 * @param {LinterType.Config} config The config for the file that generated the message.
 ...
 * @implements {ESLintType}
 */
class ESLint {
	/**
	 * The type of configuration used by this class.
	 * @type {typeof ESLintType['configType']}
	 */
	 ...
	 * @param {ESLintType.Options} options The options for this instance.
	 */
	constructor(options = {}) {
	 ...
	 * @type {typeof ESLintType['defaultConfig']}
	 */
	 ...
	 * @param {ESLintType.LintResult[]} results The lint results.
	 ...
	 * @param {ESLintType.LintResult[]} results The results to filter.
	 * @returns {ESLintType.LintResult[]} The filtered results.
	 */
	 ...
	 * @param {ESLintType.LintResult[]} results The results to fetch rules meta for.
	 ...
	 * @returns {Promise<ESLintType.LintResult[]>} The results of linting the file patterns given.
	 */
	 ...
	 * @returns {Promise<ESLintType.LintResult[]>} The results of linting the string of code given.
	 */
	 ...
	 * @returns {Promise<ESLintType.LoadedFormatter>} A promise resolving to the formatter object.
	...
	async loadFormatter(name = "stylish") {
		...
		return {
			 ...
			 * @param {ESLintType.LintResult[]} results The lint results to format.
			 * @param {ESLintType.ResultsMeta} resultsMeta Warning count and max threshold.
