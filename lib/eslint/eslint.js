 ...
 * @import { Linter as LinterType, ESLint } from "eslint";
 ...
 * @property {ConfigData|ConfigData[]} [baseConfig] Base config, extended by all configs used with this instance
 ...
 * @property {ConfigData|ConfigData[]} [overrideConfig] Override config, overrides all configs used with this instance
...
/** @type {WeakMap<FlatConfigArray, DeprecatedRuleInfo[]>} */
 ...
 * @param {Required<ESLint.Options> & ESLint.LintResult & { linter: InstanceType<typeof LinterType>; configs: FlatConfigArray; text: string }} config The config object.
