 ...
 * @import { CLIEngine as CLIEngineType, LintReport } from "../cli-engine/cli-engine.js";
 * @import { DeprecatedRuleInfo } from "../shared/types.js";
 */
 ...
 * @property {ESLint.ConfigData} [baseConfig] Base config object, extended by all configs used with this instance
 * @property {boolean} [cache] Enable result caching.
 * @property {string} [cacheLocation] The cache file to use instead of .eslintcache.
 * @property {ESLint.CacheStrategy} [cacheStrategy] The strategy used to detect changed files.
 ...
 * @property {ESLint.ConfigData} [overrideConfig] Override config object, overrides all configs used with this instance
 * @property {string} [overrideConfigFile] The configuration file to use.
 * @property {Record<string, ESLint.Plugin> | null} [plugins] Preloaded plugins. This is a map-like object, keys are plugin IDs and each value is implementation.
 * @property {Linter.StringSeverity} [reportUnusedDisableDirectives] the severity to report unused eslint-disable directives.
 ...
 * @property {CLIEngineType} cliEngine The wrapped CLIEngine instance.
 ...
 * @param {InstanceType<typeof CLIEngineType>} cliEngine The CLIEngine instance.
 ...
 * @returns {ESLint.LintResult[]} The processed linting results.
 */
 ...
 * @param {ESLint.LintResult} a The first lint result.
 * @param {ESLint.LintResult} b The second lint result.
...
class LegacyESLint {
	 ...
	 * @param {ESLint.LintResult[]} results The lint results.
	 ...
	 * @param {ESLint.LintResult[]} results The results to fetch rules meta for.
	 ...
	 * @returns {Promise<ESLint.LintResult[]>} The results of linting the file patterns given.
	 */
	 ...
	 * @returns {Promise<ESLint.LintResult[]>} The results of linting the string of code given.
	 */
	 ...
	 * @returns {Promise<ESLint.LoadedFormatter>} A promise resolving to the formatter object.
	...
	async loadFormatter(name = "stylish") {
		...
		return {
			 ...
			 * @param {ESLint.LintResult[]} results The lint results to format.
			 * @param {ESLint.ResultsMeta} resultsMeta Warning count and max threshold.
	 ...
	 * @returns {Promise<ESLint.ConfigData>} A configuration object for the file.
	 */
