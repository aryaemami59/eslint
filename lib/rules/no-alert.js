 ...
 * @param {Scope.Scope} scope The scope to search.
 * @param {Rule.Node} node The identifier node.
 * @returns {Scope.Reference|null} Returns the found reference or null if none were found.
 */
 ...
 * @param {Scope.Scope} scope The current scope.
 * @param {Rule.Node} node The identifier node to check
