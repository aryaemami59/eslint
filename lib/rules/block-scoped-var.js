...
/**
 * @import { RuleDefinition, SourceCode } from "@eslint/core";
...
module.exports = {
	...
	create(context) {
		 ...
		 * @param {Scope.Reference} reference A reference to report.
		 * @param {Scope.Definition} definition A definition for which to report reference.
		 * @returns {void}
		 */
		...
		function checkForVariables(node) {
			 ...
			 * @param {Scope.Reference} reference node to examine
