 ...
 * @param {Error & { index: number }} error The original error.
...
class FlatConfigArray extends ConfigArray {
	 ...
	 * @param {Linter.Config[]} configs An array of configuration information.
	 * @param {Partial<{basePath: string, shouldIgnore: boolean, baseConfig: ReadonlyArray<Linter.Config>}>} options The options
	 ...
	 * normalization.
	 * @param {Linter.Config} config The config to preprocess.
	 * @returns {Linter.Config} The preprocessed config.
	 */
	 ...
	 * @param {Linter.Config} config The config to finalize.
	 * @returns {Linter.Config} The finalized config.
	 * @throws {TypeError} If the config is invalid.
	 */
