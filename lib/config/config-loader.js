...
/**
 * @typedef {Object} ConfigLoaderExtraOptions
 * @property {Required<ESLint.Options>['ignore']} ignoreEnabled Indicates if ignore patterns should be honored.
 * @property {string|false|null} configFile The path to the config file to use.
 * @property {Linter.Config[]} [defaultConfigs] The default configs to use.
 * @typedef {Required<Pick<ESLint.Options, 'baseConfig' | 'cwd' | 'ignorePatterns' | 'overrideConfig'>> & ConfigLoaderExtraOptions} ConfigLoaderOptions
 */
...
class ConfigLoader {
	 ...
	 * @returns {Promise<FlatConfigArray|undefined>} A configuration object for the file
	 ...
	 * @returns {Promise<FlatConfigArray|undefined>} A configuration object for the directory
	 ...
	 * @returns {FlatConfigArray|undefined} A configuration object for the file
	 *     or `undefined` if there is no configuration data for the file.
	 * @throws {Error} If `filePath` is not a non-empty string.
	 ...
	 * @returns {FlatConfigArray|undefined} A configuration object for the directory
	 *     or `undefined` if there is no configuration data for the directory.
