...
/**
 * @typedef {Omit<Linter.Config, 'language' | 'languageOptions'> & Required<Pick<Linter.Config, 'languageOptions'>> & { language: Language | Linter.Config['language'] }} ConfigType
 */
...
/**
 * @satisfies {Map<Linter.RuleSeverity, Linter.Severity>}
 */
const severities = new Map(
	/**
	 * @type {[Linter.RuleSeverity, Linter.Severity][]}
	 */
	([
		[0, 0],
		[1, 1],
