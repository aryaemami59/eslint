...
/**
 * @import { SeverityLevel, Severity } from "@eslint/core";
...
/**
 * @satisfies {Map<Severity, SeverityLevel>}
 */
 ...
 * @throws {TypeError & { messageTemplate: string }} If a function is found in the languageOptions.
 */
	...
	for (const [key, value] of Object.entries(languageOptions)) {
		if (value) {
			...
			if (typeof value === "function") {
				/**
				 * @type {TypeError & Partial<{ messageTemplate: string; messageData: { key: string; objectKey: string } }>}
				 */
...
class Config {
	 ...
	 * @param {Linter.Config} config The configuration object.
	 */
	constructor(config) {
