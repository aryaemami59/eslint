 ...
 * @import { Directive, Language, Position } from "@eslint/core";
 */
 ...
 * @param {{node: AST.Token, value: string}} parentDirective Data about the backing directive.
 ...
 * @param {Directive[]} directives Unused directives to be removed.
 * @param {AST.Token} node The backing Comment token.
 * @param {SourceCode} sourceCode The source code object for the file being linted.
 ...
 * @returns {{ problems: Linter.LintMessage[], unusedDirectives: Linter.LintMessage[] }} An object with a list
 ...
 * @param {Linter.StringSeverity} options.reportUnusedDisableDirectives If `"warn"` or `"error"`, adds additional problems for unused directives
 * @param {Linter.RulesRecord} options.configuredRules The rules configuration.
