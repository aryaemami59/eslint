...
/**
 * @import { ConfigData, Parser, Environment, GlobalConf, LintMessage, SuppressedLintMessage, ParserOptions, LanguageOptions, Times, Processor } from "../shared/types.js";
 * @import { Language, RuleConfig, SeverityName as StringSeverity, FileError, RuleDefinition, DirectiveType } from "@eslint/core";
 ...
 * @property {Linter.Config[]|null} lastConfigArray The `ConfigArray` instance that the last `verify()` call used.
 ...
 * @property {boolean | StringSeverity} [reportUnusedDisableDirectives] Adds reported errors for
 ...
 * @param {{exportedVariables: Record<string, unknown>; enabledGlobals: Record<string, unknown>}} commentDirectives Directives from comment configuration
 * @returns {void}
 */
 ...
 */
function createDisableDirectives(options, ruleMapper, language, sourceCode) {
	const { type, value, justification, node } = options;
	const ruleIds = Object.keys(commentParser.parseListConfig(value));
	const directiveRules = ruleIds.length ? ruleIds : [null];
	/**
	 * @type {{ directives: (Omit<typeof options, 'node' | 'value'> & { parentDirective: typeof parentDirective; line: number; column: number; ruleId: string | null})[]; directiveProblems: Linter.LintMessage[] }} result
	 */
	const result = {
 ...
 * @param {ESLint.ConfigData} config Provided config.
 * @returns {{configuredRules: Object, enabledGlobals: {value:string,comment:import("esprima").Token}[], exportedVariables: Object, problems: LintMessage[], disableDirectives: DisableDirective[]}}
...
class Linter {
	 ...
	 * @param {string|SourceCode} textOrSourceCode The source code.
	 * @param {import("../cli-engine/file-enumerator.js").ConfigArray} configArray The config array.
	 * @param {VerifyOptions&ProcessorOptions} options The options.
	 * @returns {(LintMessage|SuppressedLintMessage)[]} The found problems.
	 */
	 ...
	 * Verify with a processor.
	 * @param {string|SourceCode} textOrSourceCode The source code.
	 * @param {ConfigData|import("../cli-engine/cli-engine.js").ExtractedConfig} config The config array.
	 * @param {VerifyOptions&ProcessorOptions} options The options.
	 * @param {import("../cli-engine/file-enumerator.js").ConfigArray} [configForRecursive] The `ConfigArray` object to apply multiple processors recursively.
	 * @returns {(LintMessage|SuppressedLintMessage)[]} The found problems.
	 */
	 ...
	 * @param {ConfigData|import("../cli-engine/file-enumerator.js").ConfigArray|FlatConfigArray} config The ESLint config object to use.
	...
	verifyAndFix(text, config, options) {
		...
		do {
			...
			if (
				...
				globalThis?.process?.emitWarning?.(
					`Circular fixes detected while fixing ${
