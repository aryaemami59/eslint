...
/**
 * @import { SuppressedLintMessage } from "../shared/types.js";
 * @import { Language, FileError, DirectiveType } from "@eslint/core";
 * @import { ESLint, Linter, AST, Rule } from "eslint";
 * @import { ConfigArray } from "@eslint/config-array";
 */

/**
 * @typedef {Omit<FileError, 'message'>} Location
 */
 ...
 * @property {Map<string, Linter.Parser>} parserMap The loaded parsers.
 * @property {Linter.Stats['times']} times The times spent on applying a rule to a file (see `stats` option).
 * @property {Linter.Stats['fixPasses']} fixPasses The number of times ESLint has applied at least one fix after linting.
 ...
 * @property {boolean | Linter.StringSeverity} [reportUnusedDisableDirectives] Adds reported errors for
 ...
 * @property {Linter.Processor['postprocess']} [postprocess] postprocessor for report
 *      messages. If provided, this should accept an array of the message lists
 *      for each code block returned from the preprocessor, apply a mapping to
 *      the messages as appropriate, and return a one-dimensional array of
 *      messages.
 * @property {Linter.Processor['preprocess']} [preprocess] preprocessor for source text.
 ...
 * @property {boolean | ((message: Linter.LintMessage) => boolean)} [fix] Determines
 ...
 * @property {Linter.StringSeverity} reportUnusedDisableDirectives Severity to report unused disable directives, if not "off" (boolean values were normalized).
 * @property {Linter.StringSeverity} reportUnusedInlineConfigs Severity to report unused inline configs, if not "off".
 */
 ...
 * @param {Linter.Globals} configGlobals The globals declared in configuration
 ...
 * @param {AST.SourceLocation} [options.loc] the loc to report
 * @param {string} [options.message] the error message to report
 * @param {Linter.Severity} [options.severity] the error message to report
 * @param {Language} [options.language] the language to use to adjust the location information
 * @returns {Linter.LintMessage} created problem, returns a missing-rule problem if only provided ruleId.
 * @private
 */
 ...
 * @param {ESLint.ConfigData} config Provided config.
 * @param {AST.SourceLocation} loc A line/column location
 ...
 * @param {Linter.StringSeverity} severity The severity to report.
 * @returns {void}
 */
 ...
 * @param {Rule.Node | AST.Token} options.node The Comment node/token.
 ...
 * @param {ESLint.ConfigData} config Provided config.
 * @returns {{configuredRules: Object, enabledGlobals: {value:string,comment:import("esprima").Token}[], exportedVariables: Object, problems: Linter.LintMessage[], disableDirectives: DisableDirective[]}}
 ...
 * @param {function(string): {create: Function}} ruleMapper A map from rule IDs to defined rules
 * @param {Language} language The language to use to adjust the location information
 * @returns {{ problems: Linter.LintMessage[], disableDirectives: DisableDirective[] }}
 * A collection of the directive comments that were found, along with any problems that occurred when parsing
 */
 ...
 * @param {Linter.Parser} parser The parser which uses this options.
 * @param {Linter.EcmaVersion} ecmaVersion ECMAScript version from the initial config
 ...
 * format.
 * @param {Linter.EcmaVersion} [ecmaVersion] ECMAScript version from the initial config
 * @returns {Extract<Linter.EcmaVersion, number>} normalized ECMAScript version
 */
 ...
 * @param {Linter.Config} config Config.
 ...
 * @param {Linter.Parser} parser The parser which uses this options.
 * @param {Linter.ParserOptions} providedOptions The provided 'parserOptions' key in a config
 * @param {ESLint.Environment[]} enabledEnvironments The environments enabled in configuration and with inline comments
 * @returns {Linter.ParserOptions} Resulting parser options after merge
 */
 ...
 * @param {Linter.Parser} config.parser The parser to use.
 * @param {Linter.ParserOptions} config.parserOptions The parserOptions to use.
 * @returns {Linter.LanguageOptions} The languageOptions equivalent.
 */
 ...
 * @param {Linter.Globals} providedGlobals The 'globals' key in a config
 * @param {ESLint.Environment[]} enabledEnvironments The environments enabled in configuration and with inline comments
 * @returns {Linter.Globals} The resolved globals object
 */
 ...
 * @param {Linter.Config['rules']} ruleConfig rule configuration
 ...
 * @param {Rule.Node} ast The `Program` node to analyze.
 * @param {Linter.LanguageOptions} languageOptions The parser options.
 ...
 * @param {Rule.RuleModule} rule A rule object
 * @param {Rule.RuleContext} ruleContext The context that should be passed to the rule
 * @throws {TypeError} If `rule` is not an object with a `create` method
 * @throws {any} Any error during the rule's `create`
 * @returns {Rule.NodeListener} A map of selector listeners provided by the rule
 */
 ...
 * @param {function(string): Rule.RuleModule} ruleMapper A mapper function from rule names to rules
 * @param {string | undefined} parserName The name of the parser in the config
 * @param {Language} language The language object used for parsing.
 * @param {Linter.LanguageOptions} languageOptions The options for parsing the code.
 ...
 * @returns {Linter.LintMessage[]} An array of reported problems
 ...
 * @returns {ESLint.Environment|null} The environment.
 */
 ...
 * @returns {Rule.RuleModule | null} The rule.
 */
...
class Linter {
	 ...
	 * @param {string|SourceCode} textOrSourceCode The text to parse or a SourceCode object.
	 * @param {ESLint.ConfigData | ConfigArray | undefined} config An ESLintConfig instance to configure everything.
	 * @param {(string|(VerifyOptions&ProcessorOptions))} [filenameOrOptions] The optional filename of the file being checked.
	 *      If this is not set, the filename will default to '<input>' in the rule context. If
	 *      an object, then it has "filename", "allowInlineConfig", and some properties.
	 * @returns {Linter.LintMessage[]} The results as an array of messages or an empty array if no messages.
	 */
	 ...
	 * @param {FlatConfigArray} config The config array.
	 * @param {VerifyOptions&ProcessorOptions} options The options.
	 * @param {FlatConfigArray} [configForRecursive] The `ConfigArray` object to apply multiple processors recursively.
	 * @returns {(Linter.LintMessage | SuppressedLintMessage)[]} The found problems.
	 */
	 ...
	 * @param {VFile} file The file to lint.
	 * @param {Linter.Config} providedConfig An ESLintConfig instance to configure everything.
	 * @param {VerifyOptions} [providedOptions] The optional filename of the file being checked.
	 * @throws {Error} If during rule execution.
	 * @returns {(Linter.LintMessage | SuppressedLintMessage)[]} The results as an array of messages or an empty array if no messages.
	 */
	 ...
	 * Verify with a processor.
	 * @param {string|SourceCode} textOrSourceCode The source code.
	 * @param {ESLint.ConfigData | ExtractedConfig} config The config array.
	 * @param {VerifyOptions & ProcessorOptions} options The options.
	 ...
	 * @param {(Linter.LintMessage | SuppressedLintMessage)[]} problems A list of reported problems.
	 * @returns {Linter.LintMessage[]} A list of LintMessage.
	 */
	 ...
	 * @returns {Linter.Stats['times']} The times.
	 */
	getTimes() {
	 ...
	 * @param {Record<string, Rule.RuleModule>} rulesToDefine map from unique rule identifier to rule
	 * @returns {void}
	 */
	 ...
	 * @returns {Map<string, Rule.RuleModule>} All loaded rules
	 */
	getRules() {
		assertEslintrcConfig(this);
	 ...
	 * @param {Linter.Parser} parserModule The parser object
	 * @returns {void}
	 */
	 ...
	 * @param {ESLint.ConfigData | ConfigArray | FlatConfigArray} config The ESLint config object to use.
